...
## Tâches
- Enlever les barres obliques à la fin des liens (trailing slashes) de tout le site web (https://serverlessrepo.aws.amazon.com/applications/arn:aws:serverlessrepo:us-east-1:951661612909:applications~LambdaEdgeRemoveTrailingSlash)
