...
\quad\vspace{4pt}\adjustbox{valign=t}{ \sbox0{\includegraphics[width=.45\linewidth]{assets/assets/dmg-bb/dmg-bb-4.png}}\begin{minipage}[t]{\wd0}\usebox0\par\centering\pagetwodescription Bugs Bunny\end{minipage}}
\end{center}
...
\begin{wrapfigure}{R}{0pt} \includegraphics[width=.4\linewidth]{assets/assets/dmg-cn/dmg-cn-3.png}\end{wrapfigure}
