...
\vskip 4pt
\centering
\includegraphics[width=.75\linewidth]{assets/assets/dmg-mq/dmg-mq-1.jpg}\end{figure}
\begin{itemize} [nosep]
...
\vskip 4pt
\centering
\includegraphics[width=.75\linewidth]{assets/assets/dmg-agae/dmg-agae-1.jpg}\end{figure}
\begin{itemize} [nosep]
...
\begin{center}
\quad\vspace{4pt}\adjustbox{valign=t}{ \sbox0{\includegraphics[width=.45\linewidth]{assets/assets/dmg-agae/dmg-agae-4.jpg}}\begin{minipage}[t]{\wd0}\usebox0\par\centering\pagetwodescription The initial box for the American release.\end{minipage}}
\quad\vspace{4pt}\adjustbox{valign=t}{ \sbox0{\includegraphics[width=.45\linewidth]{assets/assets/dmg-agae/dmg-agae-5.jpg}}\begin{minipage}[t]{\wd0}\usebox0\par\centering\pagetwodescription The back of the box, with the label of a Montréal toy store!\end{minipage}}
\quad\vspace{4pt}\adjustbox{valign=t}{ \sbox0{\includegraphics[width=.45\linewidth]{assets/assets/dmg-agae/dmg-agae-6.jpg}}\begin{minipage}[t]{\wd0}\usebox0\par\centering\pagetwodescription Nintendo later sold Game \& Watch devices through third parties. Nintendo would never design such a terrible blister pack.\end{minipage}}
\quad\vspace{4pt}\adjustbox{valign=t}{ \sbox0{\includegraphics[width=.45\linewidth]{assets/assets/dmg-agae/dmg-agae-7.jpg}}\begin{minipage}[t]{\wd0}\usebox0\par\centering\pagetwodescription Or that one.\end{minipage}}
\quad\vspace{4pt}\adjustbox{valign=t}{ \sbox0{\includegraphics[width=.45\linewidth]{assets/assets/dmg-agae/dmg-agae-8.jpg}}\begin{minipage}[t]{\wd0}\usebox0\par\centering\pagetwodescription In the UK, Nintendo even sold their Game \& Watch games through CGL, which rebadged LCD games from multiple companies.\end{minipage}}
\end{center}
...
\FloatBarrier\needspace{10mm}\section*{Classic and Modern}\nopagebreak[4]
...
\begin{center}
\quad\vspace{4pt}\adjustbox{valign=t}{ \sbox0{\includegraphics[width=.45\linewidth]{assets/assets/dmg-agae/dmg-agae-14.png}}\begin{minipage}[t]{\wd0}\usebox0\par\centering\pagetwodescription Classic \emph{Manhole}\end{minipage}}
\quad\vspace{4pt}\adjustbox{valign=t}{ \sbox0{\includegraphics[width=.45\linewidth]{assets/assets/dmg-agae/dmg-agae-15.png}}\begin{minipage}[t]{\wd0}\usebox0\par\centering\pagetwodescription Modern \emph{Manhole}\end{minipage}}
\quad\vspace{4pt}\adjustbox{valign=t}{ \sbox0{\includegraphics[width=.45\linewidth]{assets/assets/dmg-agae/dmg-agae-16.png}}\begin{minipage}[t]{\wd0}\usebox0\par\centering\pagetwodescription Classic \emph{Fire}\end{minipage}}
\quad\vspace{4pt}\adjustbox{valign=t}{ \sbox0{\includegraphics[width=.45\linewidth]{assets/assets/dmg-agae/dmg-agae-17.png}}\begin{minipage}[t]{\wd0}\usebox0\par\centering\pagetwodescription Modern \emph{Fire}\end{minipage}}
\quad\vspace{4pt}\adjustbox{valign=t}{ \sbox0{\includegraphics[width=.45\linewidth]{assets/assets/dmg-agae/dmg-agae-18.png}}\begin{minipage}[t]{\wd0}\usebox0\par\centering\pagetwodescription Classic \emph{Octopus}\end{minipage}}
\quad\vspace{4pt}\adjustbox{valign=t}{ \sbox0{\includegraphics[width=.45\linewidth]{assets/assets/dmg-agae/dmg-agae-19.png}}\begin{minipage}[t]{\wd0}\usebox0\par\centering\pagetwodescription Modern \emph{Octopus}\end{minipage}}
\quad\vspace{4pt}\adjustbox{valign=t}{ \sbox0{\includegraphics[width=.45\linewidth]{assets/assets/dmg-agae/dmg-agae-20.png}}\begin{minipage}[t]{\wd0}\usebox0\par\centering\pagetwodescription Classic \emph{Oil Panic}\end{minipage}}
\quad\vspace{4pt}\adjustbox{valign=t}{ \sbox0{\includegraphics[width=.45\linewidth]{assets/assets/dmg-agae/dmg-agae-21.png}}\begin{minipage}[t]{\wd0}\usebox0\par\centering\pagetwodescription Modern \emph{Oil Panic}\end{minipage}}
\end{center}
...
\begin{center}
\quad\vspace{4pt}\adjustbox{valign=t}{\includegraphics[width=.45\linewidth]{assets/assets/dmg-agae/dmg-agae-22.png}}
...
\vskip 4pt
\centering
\includegraphics[width=.75\linewidth]{assets/assets/dmg-yh/dmg-yh-1.jpg}\end{figure}
\begin{itemize} [nosep]
...
\vskip 4pt
\centering
\includegraphics[width=.75\linewidth]{assets/assets/dmg-adde/dmg-adde-1.jpg}\end{figure}
\begin{itemize} [nosep]
...
\begin{center}
\quad\vspace{4pt}\adjustbox{valign=t}{\includegraphics[width=.45\linewidth]{assets/assets/dmg-adde/dmg-adde-3.png}}
...
\FloatBarrier\needspace{10mm}\section*{Once Again Saddled With a Terrible Camera}\nopagebreak[4]
...
\FloatBarrier\needspace{10mm}\section*{Saving \& Batteries}\nopagebreak[4]
...
\vskip 4pt
\centering
\includegraphics[width=.75\linewidth]{assets/assets/cgb-bvpp/cgb-bvpp-1.jpg}\end{figure}
\begin{itemize} [nosep]
...
\vskip 4pt
\centering
\includegraphics[width=.75\linewidth]{assets/assets/cgb-bwle/cgb-bwle-1.jpg}\end{figure}
\begin{itemize} [nosep]
...
\FloatBarrier\needspace{10mm}\section*{Making a Game Boy Color title}\nopagebreak[4]
...
\begingroup \chapter*{Kid Icarus: Of Myths and Monsters}\markboth{Kid Icarus: Of Myths and Monsters}{}\addcontentsline{toc}{chapter}{Kid Icarus: Of Myths and Monsters} \endgroup
\begin{figure}[H]
\vskip 4pt
\centering
\includegraphics[width=.75\linewidth]{assets/assets/dmg-ka/dmg-ka-1.jpg}\end{figure}
\begin{itemize} [nosep]
...
\vskip 4pt
\centering
\includegraphics[width=.75\linewidth]{assets/assets/dmg-wa/dmg-wa-1.jpg}\end{figure}
\begin{itemize} [nosep]
...
\vskip 4pt
\centering
\includegraphics[width=.75\linewidth]{assets/assets/cgb-bd3e/cgb-bd3e-1.jpg}\end{figure}
\begin{itemize} [nosep]
...
\begin{center}
\quad\vspace{4pt}\adjustbox{valign=t}{\includegraphics[width=.45\linewidth]{assets/assets/cgb-bd3e/cgb-bd3e-5.jpg}}
...
\FloatBarrier\needspace{10mm}\section*{Not Hard}\nopagebreak[4]
...
\begingroup \chapter*{Pokémon: Red Version, Green Version, and Blue Version}\markboth{Pokémon: Red Version, Green Version, and Blue Version}{}\addcontentsline{toc}{chapter}{Pokémon: Red Version, Green Version, and Blue Version} \endgroup
\begin{figure}[H]
\vskip 4pt
\centering
\includegraphics[width=.75\linewidth]{assets/assets/dmg-apee/dmg-apee-1.jpg}\end{figure}
\begin{itemize} [nosep]
...
\vskip 4pt
\centering
\includegraphics[width=.75\linewidth]{assets/assets/dmg-amoe/dmg-amoe-1.jpg}\end{figure}
\begin{itemize} [nosep]
...
\vskip 4pt
\centering
\includegraphics[width=.75\linewidth]{assets/assets/dmg-ky/dmg-ky-1.jpg}\end{figure}
\begin{itemize} [nosep]
