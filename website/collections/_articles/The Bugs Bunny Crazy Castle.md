...
{% include figure.html type="pixel" figcaption="The Apple ][ version of *Lode Runner*" %}
...
{% include figure.html type="pixel" figcaption="*Roger Rabbit* on Famicom Disk System" %}
